...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_payment'])) {
    ...
    if ($receipt_required) {
        ...
        if (!isset($_FILES['payment_receipt']) || empty($_FILES['payment_receipt']['name'])) {
                ...
                <div class="modal-body">
                    ...
                    <form id="addFundsForm" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div id="usdt_form" class="payment-form">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="payment_receipt" class="form-label">إيصال الدفع (صورة لشاشة التحويل)</label>
                        ...
                        <div id="binance_form" class="payment-form">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="payment_receipt" class="form-label">إيصال الدفع</label>
                        ...
                        <div id="bank_transfer_form" class="payment-form">
                            ...
                            <div class="mb-3">
                                <label for="payment_receipt" class="form-label">إيصال التحويل</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="submit_payment" class="btn btn-primary">إتمام الدفع</button>
                        </div>
                    </form>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (paymentMethodSelect) {
        paymentMethodSelect.addEventListener('change', function() {
            ...
            // Hide all file inputs to prevent them from being submitted
            ...
            if (selectedMethod === 'credit_card') {
                ...
                document.getElementById('payment_receipt_usdt').removeAttribute('disabled');
            } else if (selectedMethod === 'binance') {
                document.getElementById('binance_form').style.display = 'block';
                document.getElementById('payment_receipt_binance').removeAttribute('disabled');
            } else if (selectedMethod === 'bank_transfer') {
                document.getElementById('bank_transfer_form').style.display = 'block';
                document.getElementById('payment_receipt_bank').removeAttribute('disabled');
                ...
                document.getElementById('payment_receipt_local').removeAttribute('disabled');
            }
        });
    }
